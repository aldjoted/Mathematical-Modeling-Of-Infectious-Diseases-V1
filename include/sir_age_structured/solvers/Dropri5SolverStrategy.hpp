...
/**
 * @brief Concrete ODE solver strategy using Boost.Odeint's Runge-Kutta-Dopri5 method.
 * 
 * This class implements the IOdeSolverStrategy interface using the Dormand-Prince (DOPRI5)
 * method, a fifth-order Runge-Kutta method with error estimation, provided by Boost.Odeint.
 * It's well-suited for solving non-stiff ODE systems with moderate accuracy requirements.
 */
class Dopri5SolverStrategy : public IOdeSolverStrategy {
public:
    /**
